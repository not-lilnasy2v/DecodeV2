...
public class AproapeRosu extends OpMode {
    ...
    private final Pose shootingPose = new Pose(84.60839160839163, 24.083916083916087, Math.toRadians(90));

    private final Pose colectare = new Pose(129.65034965034965, 35.34965034965035, Math.toRadians(0));
    private final Pose controlColectare = new Pose(79.6381931371879, 37.29370629370628);
    private final Pose tragere2 = new Pose(83.45454545454547, 24.020979020979027, Math.toRadians(90));
    private final Pose controlTragere = new Pose(102.40209790209791, 18.96153846153846);

    private final Pose luarePose = new Pose(129.6425005200749, 9.710434302539593, Math.toRadians(0));
    private final Pose controlLuare = new Pose(129.75286041189931, 9.585100254436647);
    private final Pose tragePose = new Pose(84.44055944055944, 24.36363636363636, Math.toRadians(90));

    private final Pose colectare2 = new Pose(129.54601383790958, 59.31457253162709, Math.toRadians(0));
    private final Pose controlColectare2 = new Pose(79.22755437378828, 61.433784081499006);

    private final Pose tras2Pose = new Pose(84.36025805856085, 23.587535561238276, Math.toRadians(90));
    private final Pose colectare3 = new Pose(129.57130655564846, 82.5957336702663, Math.toRadians(0));
    private final Pose controlColectare3 = new Pose(72.89083951534263, 86.87138289950515);
    private final Pose tras3Pose = new Pose(83.83851305795784, 23.860566871317477, Math.toRadians(90));

    private final Pose iesirea = new Pose(109.28773327023034, 10.97982064609837, Math.toRadians(90));
    ...
    public void buildPaths() {
        ...
        tragePath = follower.pathBuilder()
                .addPath(new BezierCurve(
                        luarePose,
                        new Pose(122.14670124558239, 12.140362282520464),
                        new Pose(118.05808345949556, 13.465777544328212),
                        new Pose(113.74232024084836, 14.8648269873475)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(23))
                .addPath(new BezierCurve(
                        new Pose(113.74232024084836, 14.8648269873475),
                        new Pose(109.65370245476153, 16.190242249155247),
                        new Pose(105.33793923611433, 17.589291692174537),
                        new Pose(101.2493214500275, 18.914706953982286)))
                .setLinearHeadingInterpolation(Math.toRadians(23), Math.toRadians(45))
                .addPath(new BezierCurve(
                        new Pose(101.2493214500275, 18.914706953982286),
                        new Pose(97.16070366394067, 20.240122215790034),
                        new Pose(92.84494044529347, 21.63917165880932),
                        new Pose(88.75632265920665, 22.964586920617073)))
