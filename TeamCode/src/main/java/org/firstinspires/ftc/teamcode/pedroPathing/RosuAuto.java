...
public class RosuAuto extends OpMode {
    ...
    private final Pose aduna1 = new Pose(93.54120005868258, 88.14210963861314,Math.toRadians(37));
    private final Pose aluat1 = new Pose(118.51322803071056, 90.17702577143136, Math.toRadians(0));
    ...
    private final Pose aduna2 = new Pose(74.77822876424275, 60.35111741405447);
    private final Pose aluat2 = new Pose(127.35141082693531,63.36681500317866, Math.toRadians(0));
    ...
    private final Pose aduna3 = new Pose(75.44525404665265, 41.74600224949872);
    private final Pose aluat3 = new Pose(130.84850114920044, 39.39478703115066 , Math.toRadians(0));
    private final Pose tras3 = new Pose(88.72727272727273,91.1958041958042,Math.toRadians(0));


    private Path scorePreload;
    private PathChain ceva1, luat1, Miss1, Recorectat1, trasUnu, ceva2, luat2, Miss2, Recorectat2, trasDoi, ceva3, luat3, trasTrei;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 5:
                if (getLoculete() >= 3 || actionTimer.getElapsedTimeSeconds() >= 5.0) {
                    intakePornit = false;
                    if (getLoculete() == 0) {
                        setPathState(50);
                    } else {
